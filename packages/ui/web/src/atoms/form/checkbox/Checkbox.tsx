      ...
      >
        ...
        <span
          ...
          className={cn(
            boxBase,
            sizeClasses[size],
            "border-(--color-border-subtle) text-(--color-primary-foreground)",
            "peer-focus-visible:outline-none peer-focus-visible:ring-2 peer-focus-visible:ring-(--color-focus-ring) peer-focus-visible:ring-offset-2",
